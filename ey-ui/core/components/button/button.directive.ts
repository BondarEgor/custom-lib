  ...
  hostDirectives: [
    {
      ...
      inputs: ['eyAppearance : appearance', 'eyAppearanceState', 'eyAppearanceFocus'],
    },
  ],
  host: {
    '[attr.data-size]': 'size',
...
export class EyButtonDirective {
  ...
  private _icon = '';
  public _appearance = this.options.appearance;

  @Input()
  set appearance(newValue: string) {
    this._appearance = newValue || this.options.appearance;
  }
